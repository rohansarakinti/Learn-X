    ...
    <>
      ...
      <div className='w-full flex justify-center content-center'>
        <div className=' w-4/5 flex flex-col justify-center items-center'>
            ...
            <Button radius="full" size="lg" variant="shadow" color='primary' className='ml-auto mr-auto mt-20 p-7'>EXPLORE NOW</Button>
        </div>  
      </div>
      <div className='w-full flex mt-52'>
        <div className='w-full flex flex-row'>
          <div className='basis-2/5 w-52 h-[600px]'><Card className='w-5/6 h-full ml-7 mt-32'></Card></div>
          <div className='basis-3/5 flex flex-col'>
            <h3 className='text-5xl'>Why LearnX is Better</h3>
                <div className='w-full h-full flex flex-col gap-10 mt-24'>
                  ...
                  <div className='flex flex-row w-full h-5 basis-1/4'>
                    ...
                    <div className='basis-5/6 flex flex-col ml-7'>
                      ...
                      <div className='basis-1/2'>
                        <h3 className='text-xl'>Videos explaining concepts in a simple yet elaborate manner.</h3>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='flex flex-row w-full h-5 basis-1/4'>
                    ...
                    <div className='basis-5/6 flex flex-col ml-7'>
                      ...
                      <div className='basis-1/2'>
                        <h3 className='text-xl'>Quizzes to test your knowledge on topics and utilize practice-based learning.</h3>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='flex flex-row w-full h-5 basis-1/4'>
                    ...
                    <div className='basis-5/6 flex flex-col ml-7'>
                      ...
                      <div className='basis-1/2'>
                        <h3 className='text-xl'>Have not just teachers, but also peers upload notes to bring in new perspectives on a topic.</h3>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='flex flex-row w-full h-5 basis-1/4'>
                    ...
                    <div className='basis-5/6 flex flex-col ml-7'>
                      ...
                      <div className='basis-1/2'>
                        <h3 className='text-xl'>Receive a certificate on completion to show credibility and proof of mastery.</h3>
                      </div>
                    </div>
                  </div>
                ...
                <Button radius="full" size="lg" variant="shadow" color='primary' className=' p-7 mt-20 mr-10'>TRY LEARNX FOR FREE</Button>
          </div>
        </div>  
      </div>
      ...
      <div className='w-full flex flex-col bg-sky-100 justify-center content-center items-center p-28'>
        <h3 className='text-5xl'>We Are Proudly Backed By...</h3>
        <img className="rounded-full p-16" src={MasterHSIcon}></img>
        <Button radius="full" size="lg" variant="shadow" color='primary' className='p-7'>SIGNUP FOR A FREE ACCOUNT</Button>
      </div>
